...
- change `Snacks` folder to the app name of your choice
- Search through entire code base for `Snack`,`Snacks` and `Snacks` to modify code to use your resource
  - `project/settings.py`
  - `project/urls.py`
  - App's files
    - `views.py`
...
- Update SnackModel with fields you need
